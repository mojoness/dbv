...
//define('ALT_DATA_PATH', false);
define('ALT_DATA_PATH', DS . 'home' . DS . 'vagrant' . DS . 'Sites' . DS . 'mojoness' . DS . 'Config' . DS . 'schema');
///Users/slewis/Sites/mojoness/Config/schema
 ...
 */
if (ALT_DATA_PATH) {
	define('DBV_DATA_PATH', ALT_DATA_PATH . DS . 'data');
} else {
